...
public class PollutionSensorInsert {
	...
	public static void main(String[] args) throws IOException, JSONException {
		PollutionSensorInsert client1 = new PollutionSensorInsert();
		client1.startConnection("localhost", 3030);
		TablesToBeInserted table = new TablesToBeInserted();
		Request req1 = new ObjectMapper().readValue(table.readFilePollutionSensor(), Request.class);
