...
public class WeatherSensorInsert {
	...
	public static void main(String[] args) throws IOException, JSONException {
		WeatherSensorInsert client1 = new WeatherSensorInsert();
		client1.startConnection("localhost", 3030);
		TablesToBeInserted table = new TablesToBeInserted();
		Request req1 = new ObjectMapper().readValue(table.readFileWeatherSensor(), Request.class);
