...
public class AirQuality extends JPanel {
	...
	public AirQuality(AppStructureHandler app) throws IOException {
		...
		/*
		 * JScrollPane scrollPane = new JScrollPane(); scrollPane.setBounds(10, 59, 317,
		 * 124); panel_1.add(scrollPane);
		 * 
		 * table = new JTable();
		 * 
		 * 
		 ...
		 * lblNewLabel.setFont(new Font("Times New Roman", Font.PLAIN, 14));
		 * lblNewLabel.setBounds(34, 22, 254, 14); panel_1.add(lblNewLabel);
		 * 
		 * JSeparator separator = new JSeparator(); separator.setBounds(30, 41, 161, 2);
		 * panel_1.add(separator);
		 * 
		 * table_1 = new JTable();
		 * 
		 ...
		 * JLabel("Nitrogen dioxide ( Hourly average : \u03B1 < 240 \u03BCg/m3 )\r\n");
		 * lblNewLabel_1.setFont(new Font("Times New Roman", Font.PLAIN, 11));
		 * lblNewLabel_1.setBounds(25, 211, 241, 23); panel_1.add(lblNewLabel_1);
		 * 
		 * JLabel lblNewLabel_2 = new
		 * JLabel("Ozone ( Daily average : \u03B1 < 120 \u03BCg/m3 )");
		 * lblNewLabel_2.setFont(new Font("Times New Roman", Font.PLAIN, 11));
		 * lblNewLabel_2.setBounds(301, 215, 193, 14); panel_1.add(lblNewLabel_2);
		 * 
		 * JLabel lblNewLabel_3 = new
		 * JLabel("PM ( Daily average : \u03B1 < 50 \u03BCg/m3 )");
		 * lblNewLabel_3.setFont(new Font("Times New Roman", Font.PLAIN, 11));
		 * lblNewLabel_3.setBounds(25, 275, 168, 14); panel_1.add(lblNewLabel_3);
		 * 
		 * JLabel lblNewLabel_4 = new
		 * JLabel("Sulfur dioxide ( Hourly average : \u03B1 < 350 \u03BCg/m3 ) ");
		 * lblNewLabel_4.setFont(new Font("Times New Roman", Font.PLAIN, 11));
		 * lblNewLabel_4.setBounds(301, 271, 278, 23); panel_1.add(lblNewLabel_4);
		 * 
		 * JSlider slider_1 = new JSlider(); slider_1.setValue(0);
		 * slider_1.setMaximum(50); slider_1.setBounds(35, 300, 200, 26);
		 * Hashtable<Integer, JLabel> labels1 = new Hashtable<>(); labels1.put(0, new
		 * JLabel("0")); labels1.put(25, new JLabel("25")); labels1.put(50, new
		 * JLabel("50")); slider_1.setLabelTable(labels1);
		 * slider_1.setPaintLabels(true); panel_1.add(slider_1);
		 * 
		 * JSlider slider_2 = new JSlider(); slider_2.setValue(0);
		 * slider_2.setMaximum(120); slider_2.setBounds(289, 238, 200, 26);
		 * Hashtable<Integer, JLabel> labels2 = new Hashtable<>(); labels2.put(0, new
		 * JLabel("0")); labels2.put(40, new JLabel("40")); labels2.put(80, new
		 * JLabel("80")); labels2.put(120, new JLabel("120"));
		 * slider_2.setLabelTable(labels2); slider_2.setPaintLabels(true);
		 * panel_1.add(slider_2);
		 * 
		 * JSlider slider_3 = new JSlider(); slider_3.setValue(0);
		 * slider_3.setMaximum(350); slider_3.setBounds(289, 300, 200, 26);
		 * Hashtable<Integer, JLabel> labels3 = new Hashtable<>(); labels3.put(0, new
		 * JLabel("0")); labels3.put(50, new JLabel("50")); labels3.put(125, new
		 * JLabel("125")); labels3.put(200, new JLabel("200")); labels3.put(275, new
		 * JLabel("275")); labels3.put(350, new JLabel("350"));
		 * slider_3.setLabelTable(labels3); slider_3.setPaintLabels(true);
		 * panel_1.add(slider_3);
		 * 
		 * JLabel lblNewLabel_7 = new JLabel("Temperature"); lblNewLabel_7.setFont(new
		 * Font("Times New Rom2an", Font.PLAIN, 11)); lblNewLabel_7.setBounds(579, 215,
		 * 84, 14); panel_1.add(lblNewLabel_7);
		 * 
		 * JSpinner spinner = new JSpinner(); spinner.setModel(new
		 * SpinnerNumberModel(20, -20, 49, 1)); spinner.setBounds(580, 238, 57, 26);
		 * panel_1.add(spinner);
		 * 
		 * JSlider slider = new JSlider();
		 * 
		 * slider.setValue(0); slider.setMaximum(240); slider.setBounds(30, 238, 200,
		 * 26); Hashtable<Integer, JLabel> labels = new Hashtable<>(); labels.put(0, new
		 * JLabel("0")); labels.put(80, new JLabel("80")); labels.put(160, new
		 * JLabel("160")); labels.put(240, new JLabel("240"));
		 * slider.setLabelTable(labels); slider.setPaintLabels(true);
		 * panel_1.add(slider);
		 * 
		 * 
		 * JButton btnNewButton = new JButton("Simulate");
		 * btnNewButton.addActionListener(new ActionListener() { public void
		 * actionPerformed(ActionEvent e) { try { int row = table.getSelectedRow(); int
		 * modelRow = table.convertRowIndexToModel(row); int idSensor = (int)
		 * table.getValueAt(modelRow, 0);
		 * 
		 * int thresholdbeta = (int) table.getValueAt(modelRow, 4); int idZone = (int)
		 * table.getValueAt(modelRow, 2);
		 * 
		 * int row_1 = table_1.getSelectedRow(); int modelRow_1 =
		 * table_1.convertRowIndexToModel(row_1); int idSensorWeather = (int)
		 * table_1.getValueAt(modelRow_1, 0);
		 * 
		 * int nd = slider.getValue(); int ozone = slider_2.getValue(); int pm =
		 * slider_1.getValue(); int sulfur = slider_3.getValue();
		 * 
		 * int temp = (Integer) spinner.getValue();
		 * 
		 * int s = 0; s += nd; s += ozone; s += pm; s += sulfur; double average = s / 4;
		 * System.out.println("thressss " + thresholdbeta);
		 * simulateAlgoPollution(average, thresholdbeta, temp, idSensor, idZone,
		 * idSensorWeather, app); } catch (IOException | IndexOutOfBoundsException e1) {
		 * JOptionPane.showMessageDialog(null,
		 * "Please choose the pollution and weather sensor", "Choose sensor",
		 * JOptionPane.WARNING_MESSAGE);
		 * 
		 * }
		 * 
		 * } }); btnNewButton.setForeground(new Color(255, 255, 255));
		 * btnNewButton.setBackground(new Color(34, 139, 34)); btnNewButton.setFont(new
		 * Font("Times New Roman", Font.BOLD, 12)); btnNewButton.setBounds(583, 300, 99,
		 * 23); panel_1.add(btnNewButton);
		 * 
		 ...
		 * ArrayList<String> al; try { al = app.sendMessageToServer(request);
		 * 
		 * Object[] temp = new Object[5];
		 * 
		 * for (int i = 0; i < al.size(); i++) { String s = al.get(i) + "\n"; Sensor
		 * req1 = new ObjectMapper().readValue(s, Sensor.class); temp[0] =
		 * req1.getIdSensor(); temp[1] = req1.getSensorType(); ArrayList<String> azone =
		 * new ArrayList<String>(); azone.add(String.valueOf(req1.getIdZone())); Request
		 * request1 = new Request("SELECT_ZONE", "zone", azone); ArrayList<String> al1 =
		 * app.sendMessageToServer(request1); Zone req2 = new
		 * ObjectMapper().readValue(al1.get(0), Zone.class); temp[2] = req2.getIdZone();
		 * temp[3] = req2.getNextToTheZone(); temp[4] = req2.getThresholdBeta();
		 * 
		 * dtm1.addRow(temp);
		 * 
		 * }
		 * 
		 * table.setModel(dtm1); scrollPane.setViewportView(table);
		 * 
		 * 
		 * String header[] = new String[] { "ID", "Type", "Zone" }; DefaultTableModel
		 * dtm2 = new DefaultTableModel(header, 0);
		 * 
		 * Request request1 = new Request("SELECT_WEATHER", "sensor"); ArrayList<String>
		 * al1 = app.sendMessageToServer(request1); Object[] temp1 = new Object[4];
		 * 
		 * for (int i = 0; i < al1.size(); i++) { String s = al1.get(i) + "\n"; Sensor
		 * req1 = new ObjectMapper().readValue(s, Sensor.class); temp1[0] =
		 * req1.getIdSensor(); temp1[1] = req1.getSensorType(); ArrayList<String> azone
		 * = new ArrayList<String>(); azone.add(String.valueOf(req1.getIdZone()));
		 * Request request2 = new Request("SELECT_ZONE", "zone", azone);
		 * ArrayList<String> al2 = app.sendMessageToServer(request2); Zone req2 = new
		 * ObjectMapper().readValue(al2.get(0), Zone.class);
		 * 
		 * temp1[2] = req2.getNextToTheZone(); dtm2.addRow(temp1);
		 * 
		 * }
		 * 
		 ...
		 * btnNewButton_2.setBounds(291, 19, 89, 23); panel_1.add(btnNewButton_2);
		 * 
		 */
