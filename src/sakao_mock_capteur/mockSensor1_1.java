...
public class mockSensor1_1 {
	...
	public static void main(String[] args) throws IOException, JSONException {
		...
		Request req3 = new ObjectMapper().readValue(table.readFileVehiclesSensor1T1(), Request.class);
		...
		System.out.println("");
		Request req4 = new ObjectMapper().readValue(table.readFileVehiclesSensor1T2(), Request.class);
		...
		System.out.println("");
		Request req5 = new ObjectMapper().readValue(table.readFileVehiclesSensor1T3(), Request.class);
		...
		System.out.println("");
		Request req6 = new ObjectMapper().readValue(table.readFileVehiclesSensor1T4(), Request.class);
		...
		System.out.println("");
		Request req7 = new ObjectMapper().readValue(table.readFileVehiclesSensor1T5(), Request.class);
