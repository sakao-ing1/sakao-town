...
public class mockSensor1_3 {
	...
	public static void main(String[] args) throws IOException, JSONException {
		mockSensor1_3 client1 = new mockSensor1_3();
		...
		Request req3 = new ObjectMapper().readValue(table.readFileVehiclesSensor3T1(), Request.class);
		...
		System.out.println("");
		Request req4 = new ObjectMapper().readValue(table.readFileVehiclesSensor3T2(), Request.class);
		...
		System.out.println("");
		Request req5 = new ObjectMapper().readValue(table.readFileVehiclesSensor3T3(), Request.class);
		...
		System.out.println("");
		Request req6 = new ObjectMapper().readValue(table.readFileVehiclesSensor3T4(), Request.class);
		...
		System.out.println("");
		Request req7 = new ObjectMapper().readValue(table.readFileVehiclesSensor3T5(), Request.class);
