...
public class mockSensor1_2 {
	...
	public static void main(String[] args) throws IOException, JSONException {
		mockSensor1_2 client1 = new mockSensor1_2();
		...
		Request req3 = new ObjectMapper().readValue(table.readFileVehiclesSensor2T1(), Request.class);
		...
		System.out.println("");
		Request req4 = new ObjectMapper().readValue(table.readFileVehiclesSensor2T2(), Request.class);
		...
		System.out.println("");
		Request req5 = new ObjectMapper().readValue(table.readFileVehiclesSensor2T3(), Request.class);
		...
		System.out.println("");
		Request req6 = new ObjectMapper().readValue(table.readFileVehiclesSensor2T4(), Request.class);
		...
		System.out.println("");
		Request req7 = new ObjectMapper().readValue(table.readFileVehiclesSensor2T5(), Request.class);
