...
// TEST 
public class UpdateVehicleSensor2 {
	...
	public static void main(String[] args) throws IOException, JSONException {
		UpdateVehicleSensor2 client1 = new UpdateVehicleSensor2();
		...
		Request req3 = new ObjectMapper().readValue(table.readFileVehiclesTEST2(), Request.class);
